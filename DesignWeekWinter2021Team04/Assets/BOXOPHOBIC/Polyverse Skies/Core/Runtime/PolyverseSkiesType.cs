...
[ExecuteInEditMode]
public class PolyverseSkiesType : StyledMonoBehaviour
{
    ...
    [StyledMessage("Info", "The Time Of Day feature will interpolate between two Polyverse Skies materials. Please note that not all material properties such as textures and keywords will not be interpolated! Toggle Update Lighting to enable Unity's realtime environment lighting!", 0, 10)]
